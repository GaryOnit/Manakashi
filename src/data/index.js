...
export const GALLERY_IMAGES = [
  { src: asset('/images/gallery/1.webp'), label: 'SCENE 01' },
  { src: asset('/images/gallery/2.webp'), label: 'SCENE 02' },
  { src: asset('/images/gallery/3.webp'), label: 'SCENE 03' },
  { src: asset('/images/gallery/4.webp'), label: 'SCENE 04' },
  { src: asset('/images/gallery/5.webp'), label: 'SCENE 05' },
  { src: asset('/images/gallery/6.webp'), label: 'SCENE 06' },
];
